...
<div class="card card-outline card-primary mb-5">
    <div class="card-header">
        <h3 class="card-title"><a class="text-dark" href="{{ route('dashboard') }}"><i class="fas fa-reply pr-2"
                    role="button"></i></a>Lista Precios</h3>
    ...
    <div class="card-body p-2 pt-3">
        ...
        <div class="col-12 mb-3">
            <input class="form-control" type="text" name="buscador" id="buscador" placeholder="Buscar Producto..."
                autofocus>
        </div>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ number_format($comedi01->comedilps->where('clistpr', '001')->first()->qprecio /
                        $comedi01->qfaccon, 2) }}</td>
